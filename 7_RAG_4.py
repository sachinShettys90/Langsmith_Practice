...
# NOTE: This avoid chunking and embedding multiple times with indexing
...
os.environ['LANGCHAIN_PROJECT'] = 'RAG with OneTimeChunking_Split_Emb_VS'
...
# NOTE: we can observe for the first run it will take time and it generate the .indices
# for the next run , it won't perform chunking , embedding and vs , it will generate and retrive from the existing chunks and this helps us to reduce the latency
