...
# NOTE:To avoid this pdf_rag_query and setup_pipeline(load_pdf,split_documents,build_Vs) saparately
# we club all three function under split_documents
...
os.environ['LANGCHAIN_PROJECT'] = 'RAG with concatinateSetup'
