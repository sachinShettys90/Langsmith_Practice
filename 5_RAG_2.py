...
# NOTE : Here its giving pdf_rag_query and setup_pipeline(load_pdf,split_documents,build_Vs) saparately
# NOTE : but we have huge latency using this
# to avoid the saparate setup_pipeline , we club all three function under split_documents
# refer-------->6_RAG_3.py
